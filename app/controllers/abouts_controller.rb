class AboutsController < ApplicationController
  def index
		@profile_list = [
			...
			[
				'主仕入先', '<p class="partner_link"><a href="https://www.sedia-green.co.jp/" target="_blank">渡辺パイプ(株)</a> | <a href="https://n-seikaken.co.jp/" target="_blank">生科研(株)</a> | <a href="http://www.taiyoo-kk.co.jp/" target="_blank">タイヨー(株)</a></p>
				全農 日本マタイ(株) 三甲(株) 三菱化学ケミカルアグリドリーム(株) 東京インキ(株) ストラパック(株) イワタニアグリグリーン(株) カネコ種苗(株) タキイ種苗(株) 辻野プラスチックス工業(株) タキロン・シーアイ(株) 住化農業資材(株) 住化積水フィルム(株)'
			],
